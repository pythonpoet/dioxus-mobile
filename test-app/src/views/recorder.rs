...
#[cfg(feature = "recorder")]
/// Recorder module test page: denoised recording and local playback.
#[component]
pub fn Recorder() -> Element {
    ...
    // Helper to dynamically update the recording file size metadata on the UI.
    ...
    rsx! {
        div {
            ...
            div {
                ...
                p {
                    style: "font-size: 14px; color: #94a3b8; margin: 0;",
                    "Audio recording is available on native client builds (mobile/desktop)."
                }
            }
        }
    }
